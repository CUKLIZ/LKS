...
namespace Simulasi3
{
    public partial class Terima : UserControl
    {
        public Terima()
        {
            InitializeComponent();
        ...
        {
                SqlCommand cmd = new SqlCommand("SELECT * FROM Pesanan WHERE Status = 'Pending'", conn);
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                TotalTiket.Text = row.Cells["TotalTiket"].Value.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("UPDATE Pesanan SET Status = 'Accepted' WHERE IdPesanan = @IdPesanan", conn);
        ...
        private void Tolak_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Pesanan SET Status = 'Rejected' WHERE IdPesanan = @IdPesanan", conn);
                cmd.Parameters.AddWithValue("@IdPesanan", IdPesanan.Text);
